...
@section('title')
    Fade Kopi Admin - Product Edit Page
@endsection
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="users_id" class="form-control">
                                                    <option value="{{ $item->users_id }}">{{ $item->user->name }}
                                                    </option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="category_name" required
                                                    placeholder="Konfirmasi Ulang Nama Kategori Sesuai Kategori Diatas"
